...
CREATE TABLE IF NOT EXISTS log_usage (
    id SERIAL PRIMARY KEY,
    action VARCHAR(255) NOT NULL,  -- Definir um limite evita desperdício de armazenamento
...
CREATE TABLE IF NOT EXISTS appointment (
    ...
    end_date DATE NULL,  -- Data de término do atendimento
    description TEXT NULL,  -- Permite observações adicionais
...
CREATE TABLE IF NOT EXISTS assistive_technology (
    ...
    description TEXT NULL  -- Permite observações sobre a tecnologia assistiva
);
